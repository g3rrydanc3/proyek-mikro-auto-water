...
;(function()
{
	 ...
	 */
	 ...
	 evothings.arduinotcp.kirimSpesial = function(str){
		 internal.sendRequest(str, internal.callbackFun);

		 var myVar = setInterval(myTimer, 200);

		 function myTimer() {
			 if (internal.receiveBuffer!=""){
				 //alert(internal.receiveBuffer);
				 var tmp = (internal.receiveBuffer).split("%");
				 $("#progressbar").attr("value",parseInt(tmp[0]));
				 if (parseInt(tmp[1])==0){
					 $("#labelMati").show();
					 $("#labelNyala").hide();
					 $("#labelTanya").hide();
	 ...
	 evothings.arduinotcp.kirim = function(str){
		 internal.sendRequest(str, internal.callbackFun);
	 }
