...
const int trigUltra = 38; //pin trigger ultrasound
const int echoUltra = 39; //pin echo ultrasound
const int pompa = 37; //pin pompa/relay

const byte ROWS = 4; //jumlah baris keypad
const byte COLS = 3; //jumlah kolom keypad

char keys[ROWS][COLS] = { //define bentuk keypad
  {'1','2','3'},
  {'4','5','6'},
  {'7','8','9'},
  {'*','0','#'}
...
byte rowPins[ROWS] = { 36, 34, 32, 30 }; //pin baris keypad
byte colPins[COLS] = { 28, 26, 24 }; //pin kolom keypad

LiquidCrystal_I2C lcd(0x27, 2, 1, 0, 4, 5, 6, 7, 3, POSITIVE); //init lcd
